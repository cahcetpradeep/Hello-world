...
public partial class Develop2Child : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       // attribute.Value = TextBox5.Text;
        ...
        userNode.InnerText = TextBox7.Text;
        ...
        if (TextBox5.Text.Length != 0)
        {
          ...
          //  userNode1.Attributes.Append(attribute1);
            ...
            userNode1.InnerText = TextBox9.Text;
            //userNode.InnerText = "prabu";
            rootNode.AppendChild(userNode1);
        }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        ds.ReadXml(Server.MapPath("Develop1child.xml"));
